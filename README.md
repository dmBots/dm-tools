...
- 如果你需要确认 GitHub 镜像是否也覆盖了某个工具分支，请先看 [../../docs/mirror-scope.md](../../docs/mirror-scope.md)。
...
- 想确认当前仓库有没有你要的内容：如果本页已经列出对应入口，就按对应 README 继续；如果本页没有，先看 [../../docs/mirror-scope.md](../../docs/mirror-scope.md) 判断它是不是当前仍以 Gitee 为准。
- 在 GitHub 上没找到完整资料：先看 [../../docs/mirror-scope.md](../../docs/mirror-scope.md)，再切到 Gitee 中文主仓继续。
