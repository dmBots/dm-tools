...
- 如果你正在对照 GitHub 镜像找资料，先看 [../../../docs/mirror-scope.md](../../../docs/mirror-scope.md)。
...
- [SDK/README.md](SDK/README.md) - SDK 入口；先区分旧版资料、语言和平台
...
- 想接入 SDK：先看 [SDK/README.md](SDK/README.md)，确认你要的是 USB2CANFD 旧版 SDK 还是更通用的 USB 设备 SDK 路线。
- 想确认 GitHub 上有没有完整资料：先看 [../../../docs/mirror-scope.md](../../../docs/mirror-scope.md)，再决定是否回到 Gitee。

## 状态

- ZH: 主版
- EN: Translation pending
- TBD: 版本更新与历史说明保留在 `SETUP.md`
