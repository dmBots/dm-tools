...
- 如果你正在对照 GitHub 镜像找资料，先看 [GitHub / Gitee 覆盖范围说明](https://gitee.com/kit-miao/damiao/blob/master/docs/repository/mirror-scope.md)。

## 文档 / 资源

- [SETUP.md](SETUP.md) - 模块安装、权限、连通性检查和基础运行准备
- [SETUP.md](SETUP.md) - 上位机与基础连接准备；先在这里完成安装与连接
...
- 想运行上位机：先看 [SETUP.md](SETUP.md)，完成安装、连接与权限准备。
...
- 想确认 GitHub 上有没有完整资料：先看 [GitHub / Gitee 覆盖范围说明](https://gitee.com/kit-miao/damiao/blob/master/docs/repository/mirror-scope.md)，再决定是否回到 Gitee。
