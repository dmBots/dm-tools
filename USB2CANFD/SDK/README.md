...
- 当前这里保留的是 USB2CANFD 旧版 SDK 分支；如果你要做更通用的 USB 类设备开发，优先去 [DM Device SDK](https://gitee.com/kit-miao/dm-device-sdk)。
...
- [DM Device SDK](https://gitee.com/kit-miao/dm-device-sdk) - 通用 USB 类设备 SDK 入口
- [GitHub / Gitee 覆盖范围说明](https://gitee.com/kit-miao/damiao/blob/master/docs/repository/mirror-scope.md) - 查看双仓覆盖范围说明
...
- 想做更新的通用 USB 设备接入：改看 [DM Device SDK](https://gitee.com/kit-miao/dm-device-sdk)。
- 想确认 GitHub 上是否也有对应资料：先看 [GitHub / Gitee 覆盖范围说明](https://gitee.com/kit-miao/damiao/blob/master/docs/repository/mirror-scope.md)。
